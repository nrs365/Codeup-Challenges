<?php
//You're program should take in the name of his character, 
//open the script text, and 
//output only the lines for his character.
...
$character_lines = "Lane.  ";
echo strpos($earnest_script, $character_lines) . PHP_EOL;
substr($string, $starting_int,$length);
//ending line is probably "\n\n"
